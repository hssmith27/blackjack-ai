...
# Maps each action to a num for our heatmap
ACTION_TO_NUM = {
    "stand": 0,
    "hit": 1,
    "double": 2,
...
# Maps nums back to action labels to annotate our heatmap
NUM_TO_ACTION = {
    0: "S",
    1: "H",
    2: "D",
...
def generate_policy(is_soft=False, true_count=0):
    '''
    ...
    '''
    totals = get_player_dealer_totals(is_soft)
...
def generate_heat_map(is_soft, true_count, policy, labeled_policy):
    '''
...
policy_vals, labeled_policy_vals = generate_policy(IS_SOFT, TRUE_COUNT)
generate_heat_map(IS_SOFT, TRUE_COUNT, policy_vals, labeled_policy_vals)
